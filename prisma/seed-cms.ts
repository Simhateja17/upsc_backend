...
const pages: PageSeed[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "hero_badge", type: "text", content: "FREE STUDY MATERIALS", order: 1 },
      { key: "hero_title", type: "text", content: "Master UPSC with Expert Notes and Free Resources", order: 2 },
      { key: "hero_subtitle", type: "text", content: "From PYQ-backed notes to concise summaries — everything you need, free.", order: 3 },
      { key: "hero_stats", type: "json", content: JSON.stringify([
      ...
      { key: "sidebar_header_title", type: "text", content: "CHOOSE A SUBJECT", order: 5 },
      { key: "sidebar_header_subtitle", type: "text", content: "{activeCount} Active · {comingSoonCount} Coming Soon", order: 6 },
      { key: "tabs", type: "json", content: JSON.stringify(["Notes", "PYQ Notes"]), order: 7 },
      { key: "section_label_notes", type: "text", content: "FOUNDATIONAL NOTES", order: 8 },
      { key: "section_label_pyq", type: "text", content: "PREVIOUS YEAR QUESTIONS", order: 9 },
      ...
      { key: "banner_badge", type: "text", content: "WHY RISE WITH JEET", order: 11 },
      { key: "banner_title", type: "text", content: "Not just notes. A system built to crack UPSC.", order: 12 },
      { key: "banner_subtitle", type: "text", content: "Every PDF is designed with one obsession — your selection. Here's what makes us different from every other resource out there.", order: 13 },
      { key: "banner_stat_number", type: "text", content: "15K+", order: 14 },
      { key: "banner_stat_label", type: "text", content: "Aspirants trust\nRise with Jeet", order: 15 },
      { key: "bottom_stats", type: "json", content: JSON.stringify([
      ...
      { key: "testimonials_badge", type: "text", content: "ASPIRANT STORIES", order: 17 },
      { key: "testimonials_title", type: "text", content: "What UPSC Aspirants Say", order: 18 },
      { key: "cta_title", type: "text", content: "Ready to start your IAS journey the right way?", order: 19 },
      { key: "cta_subtitle", type: "text", content: "Access 360+ free PDFs, PYQ notes, and study roadmaps — all designed to help you crack UPSC on your first attempt.", order: 20 },
      { key: "cta_button_primary", type: "text", content: "Start Studying Free", order: 21 },
      { key: "cta_button_secondary", type: "text", content: "Watch on YouTube", order: 22 },
    ],
  },
  {
    slug: "dashboard/syllabus-tracker",
    title: "Syllabus Tracker",
    description: "Syllabus tracker page content",
    sections: [
      ...
      { key: "status_labels", type: "json", content: JSON.stringify({ none: "Not Started", done: "Done", in_progress: "Reading", needs_revision: "Needs Revision", weak: "Weak Area" }), order: 7 },
      ...
      { key: "subtopic_placeholder_subtitle", type: "text", content: "Select a topic to start tracking", order: 15 },
      { key: "subtopic_placeholder_body", type: "text", content: "Select a subject, then tap a topic to begin tracking progress.", order: 16 },
      { key: "stats_strip_labels", type: "json", content: JSON.stringify({ total: "Total", done: "Done", active: "Active", left: "Left" }), order: 17 },
      { key: "pyq_button", type: "text", content: "📜 PYQs", order: 18 },
    ],
  },
  {
