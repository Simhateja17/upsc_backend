...
import { getSubjects, getChapters, getDownloadUrl, getMaterialDownloadUrl } from "../controllers/library.controller";
...
router.get("/download/material/:materialId", authenticate, getMaterialDownloadUrl);
