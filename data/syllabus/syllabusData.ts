  ...
  optional: [
    {
      ...
      topics: [
        {
          name: 'Section A — Core Theory',
          subs: [
            'Unit 1 — Foundations & Origins',
            'Unit 2 — Core Theories & Models',
            'Unit 3 — Advanced Concepts',
            'Unit 4 — Schools of Thought',
          ],
        },
        {
          name: 'Section B — Applied',
          subs: [
            'Unit 5 — Applied Analysis',
            'Unit 6 — Case Studies',
            'Unit 7 — Contemporary Issues',
            'Unit 8 — Comparative Analysis',
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          subs: [
            'Unit 1 — Advanced Theory',
            'Unit 2 — Historical Context',
            'Unit 3 — Key Thinkers',
            'Unit 4 — Thematic Analysis',
          ],
        },
        {
          name: 'Section B — Current',
          subs: [
            'Unit 5 — Current Debates',
            'Unit 6 — Policy Dimensions',
            'Unit 7 — International Dimensions',
            'Unit 8 — Practice & Revision',
          ],
        },
      ],
    },
